...
def banner():
   ...
   '🇸 🇺 🇧  🇹 🇴  🇫 🇦 🇳 🇹 🇮 🇰  🇨 🇭 🇪 🇦 🇹 🇸 ',
   '🇸 🇺 🇧  🇹 🇴  🇫 🇦 🇳 🇹 🇮 🇰  🇨 🇭 🇪 🇦 🇹 🇸 ',
   'By ДеадДос, участник Fant1k-cheats и LUD Team',

    ]
    for char in b:
        print(f'{random.choice(colors)}{char}{n}')
    print(f'{r}   {r}')
    print(f'{r} Скрапер Дедоса{r}')
    print(f'{cy} Лучший скрапер на ТГ(ну почти){cy}')
    print(f'{r}   {r}')
...
while True:
    ...
    print(lg+'[1] Добавить новые акки'+n)
    print(lg+'[2] Фильтр забаненных акков'+n)
    print(lg+'[3] Удалить определённый аккаунт'+n)
    ...
    if a == 1:
        ...
        webbrowser.open('https://t.me/DeadDoce')
        clr()
        banner()
        exit()
